...
│   ├── pwa_offline_check.py # 📱 فحص PWA/العمل دون اتصال (22 فحصًا — يحتاج خادمًا على 8001)
...
└── app/
    ...
    ├── database.py          # إعداد قاعدة البيانات (WAL + توازن اتصالات 20+30)
...
python tests/pwa_offline_check.py       # 📱 PWA + العمل دون اتصال (22 فحصًا — يحتاج خادمًا على 8001)
