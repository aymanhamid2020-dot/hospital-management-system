...
- 🧪 **اختبارات آلية pytest** (288 اختبارًا) — `python -m pytest`
...
│   ├── test_stock_ops.py     # 📦 إدارة المخازن: مستودعات + مستندات (استلام/تحويل/صرف/مرتجع/جرد) + FEFO + تقارير (10)
...
### الاختبارات
```bash
python -m pytest                        # 288 اختبارًا آليًا
