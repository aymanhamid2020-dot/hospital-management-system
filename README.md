...
- 🧪 **اختبارات آلية pytest** (194 اختبارًا) — `python -m pytest`
...
- 🧩 **تقسيم الواجهة** — `index.html` صار هيكلًا صغيرًا (107 سطرًا) + `app.js` (3358 سطرًا منطق SPA كامل) + `app.css` (213 سطرًا) — تُخدَّم بـ`no-cache` وتضمّنها قائمة شل PWA الخمسة
...
├── static/
│   ├── index.html           # 🖥️ هيكل الصفحة (107 سطرًا — عربي/إنجليزي)
│   ├── app.js               # 🖥️ منطق الواجهة SPA كاملًا (i18n + كل الشاشات — 3358 سطرًا)
│   ├── app.css              # 🖥️ أنماط الواجهة (213 سطرًا)
