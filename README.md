...
│   │   ├── inventory-ops.spec.ts # 📦 الأقسام الستة للمخزون + تدفّق مستودع/صنف/إذن استلام (3)
...
npm run test:e2e                     # 51 اختبارًا: الأطباء 7 + ملف الطبيب 2 + الأساسية 6 + المحاسبة 5 + شؤون الموظفين 3 + ملف المريض 2 + قائمة المرضى 6 + بوابة المريض 2 + إدارة المخازن 3 + مركز الأقسام 2 + اللقطات 4 + المعرض 9
