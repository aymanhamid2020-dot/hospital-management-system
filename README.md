...
- 🧪 **اختبارات آلية pytest** (276 اختبارًا) — `python -m pytest`
...
### الاختبارات
```bash
python -m pytest                        # 249 اختبارًا آليًا
...
npm run test:e2e                     # 44 اختبارًا: الأطباء 7 + ملف الطبيب 2 + الأساسية 6 + المحاسبة 5 + شؤون الموظفين 3 + ملف المريض 2 + قائمة المرضى 6 + اللقطات 4 + المعرض 9
